...
is_compound: all non-fundamental. e.g. class/struct, enum, function, pointers, references
...
is_scalar: includes arithmetic, pointers, member pointer, enums, and nullptr */
...
//static_assert(is_scalar<X>::value, "X is not a scalar");
return 0;
}